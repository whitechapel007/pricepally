...
(gj.widget = function () {
  ...
  (gj.core = {
    ...
    addclassNamees: function (a, b) {
      var c, d;
      if (b)
        for (d = b.split(" "), c = 0; c < d.length; c++)
          a.classNameList.add(d[c]);
    },
    position: function (a) {
      for (
    ...
    initialize: function (a, b, c) {
      ...
      (d =
        "bootstrap" === b.uiLibrary
          ...
          ? $(
              '<span className="input-group-append"><button className="btn btn-outline-secondary border-left-0" type="button">' +
                b.icons.rightIcon +
                "</button></span>"
            )
          : $(b.icons.rightIcon)),
        ...
        0 === f.length
          ? ((f = $('<div role="wrapper" />').addclassName(b.style.wrapper)),
            a.wrap(f))
          : f.addclassName(b.style.wrapper),
        (f = a.parent('div[role="wrapper"]')),
        b.width && f.css("width", b.width),
        a.val(b.value).addclassName(b.style.input).attr("role", "input"),
        b.fontSize && a.css("font-size", b.fontSize),
        "bootstrap" === b.uiLibrary || "bootstrap4" === b.uiLibrary
          ? "small" === b.size
            ? (f.addclassName("input-group-sm"),
              a.addclassName("form-control-sm"))
            : "large" === b.size &&
              (f.addclassName("input-group-lg"),
              a.addclassName("form-control-lg"))
          : "small" === b.size
          ? f.addclassName("small")
          : "large" === b.size && f.addclassName("large"),
  ...
  (gj.dialog.methods = {
    ...
    initialize: function (a) {
      var b,
        ...
        d,
        e = a.data();
      a.addclassName(e.style.content),
        ...
        0 === c.length
          ? ((c = $('<div data-role="body"/>').addclassName(e.style.body)),
            a.wrapInner(c))
          : c.addclassName(e.style.body),
        (b = gj.dialog.methods.renderHeader(a)),
        (d = a
          .children('div[data-role="footer"]')
          .addclassName(e.style.footer)),
        ...
        e.scrollable &&
          e.height &&
          (a.addclassName("gj-dialog-scrollable"),
        ...
        e.modal &&
          a.wrapAll(
            '<div data-role="modal" className="' + e.style.modal + '"/>'
          ),
        e.autoOpen && a.open();
    },
    setSize: function (a) {
      ...
      return (
        ...
        0 === d.length && e.closeButtonInHeader
          ? ((d = $(
            ...
            d.addclassName(e.style.headerCloseButton),
            b.append(d))
    ...
    draggable: function (a, b) {
      a.appendTo("body"),
        b.addclassName("gj-draggable"),
        a.draggable({
          handle: b,
          start: function () {
            a.addclassName("gj-unselectable"), gj.dialog.events.dragStart(a);
          },
          stop: function () {
            a.removeclassName("gj-unselectable"), gj.dialog.events.dragStop(a);
          },
        });
    },
    resizable: function (a) {
      var b = {
        ...
        start: function () {
          a.addclassName("gj-unselectable"), gj.dialog.events.resizeStart(a);
        },
        stop: function () {
          this.removeAttribute("style"),
            a.removeclassName("gj-unselectable"),
            gj.dialog.events.resizeStop(a);
        },
      };
      a.append(
        $(
          '<div className="gj-resizable-handle gj-resizable-n"></div>'
        ).draggable(
          $.extend(
            !0,
            {
        ...
        a.append(
          $(
            '<div className="gj-resizable-handle gj-resizable-e"></div>'
          ).draggable(
            $.extend(
              !0,
              {
        ...
        a.append(
          $(
            '<div className="gj-resizable-handle gj-resizable-s"></div>'
          ).draggable(
            $.extend(
              !0,
              {
        ...
        a.append(
          $(
            '<div className="gj-resizable-handle gj-resizable-w"></div>'
          ).draggable(
            $.extend(
              !0,
              {
        ...
        a.append(
          $(
            '<div className="gj-resizable-handle gj-resizable-ne"></div>'
          ).draggable($.extend(!0, {}, b))
        ),
        a.append(
          $(
            '<div className="gj-resizable-handle gj-resizable-nw"></div>'
          ).draggable($.extend(!0, {}, b))
        ),
        a.append(
          $(
            '<div className="gj-resizable-handle gj-resizable-sw"></div>'
          ).draggable($.extend(!0, {}, b))
        ),
        a.append(
          $(
            '<div className="gj-resizable-handle gj-resizable-se"></div>'
          ).draggable($.extend(!0, {}, b))
        );
    },
    resize: function (a, b) {
      ...
      return (
        ...
        (f = d.data()),
        c.hasclassName("gj-resizable-n")
          ? ((g = d.height() - offset.top), (i = d.offset().top + offset.top))
          : c.hasclassName("gj-resizable-e")
          ? (h = d.width() + offset.left)
          : c.hasclassName("gj-resizable-s")
          ? (g = d.height() + offset.top)
          : c.hasclassName("gj-resizable-w")
          ? ((h = d.width() - offset.left), (j = d.offset().left + offset.left))
          : c.hasclassName("gj-resizable-ne")
          ? ((g = d.height() - offset.top),
            (i = d.offset().top + offset.top),
            (h = d.width() + offset.left))
          : c.hasclassName("gj-resizable-nw")
          ? ((g = d.height() - offset.top),
            (i = d.offset().top + offset.top),
            (h = d.width() - offset.left),
            (j = d.offset().left + offset.left))
          : c.hasclassName("gj-resizable-se")
          ? ((g = d.height() + offset.top), (h = d.width() + offset.left))
          : c.hasclassName("gj-resizable-sw") &&
            ((g = d.height() + offset.top),
            (h = d.width() - offset.left),
            (j = d.offset().left + offset.left)),
        g &&
        ...
        c &&
          (!1 === b
            ...
            : (a.close(),
              ...
              a.removeclassName(c.style.content),
              a.find('[data-role="header"]').removeclassName(c.style.header),
              a
                .find('[data-role="title"]')
                .removeclassName(c.style.headerTitle),
              a.find('[data-role="close"]').remove(),
              a.find('[data-role="body"]').removeclassName(c.style.body),
              a.find('[data-role="footer"]').removeclassName(c.style.footer))),
        a
      );
    },
  }),
    ...
    createMouseMoveHandler: function (a) {
      return function (b) {
        if (a.isDragging) {
          ...
          e != a.isOver &&
            (e
              ? (c && a.addclassName(c), gj.droppable.events.over(a, d))
              : (c && a.removeclassName(c), gj.droppable.events.out(a))),
            (a.isOver = e);
        }
      };
    },
  ...
  (gj.grid.methods = {
    ...
    initialize: function (a) {
      ...
      gj.grid.methods.localization(b),
        0 === c.length
          ? ((c = $('<div data-role="wrapper" />').addclassName(
              b.style.wrapper
            )),
            a.wrap(c))
          : c.addclassName(b.style.wrapper),
        b.width && a.parent().css("width", b.width),
        b.minWidth && a.css("min-width", b.minWidth),
        b.fontSize && a.css("font-size", b.fontSize),
        "autogrow" === b.headerRowHeight &&
          a.addclassName("autogrow-header-row"),
        "fixed" === b.bodyRowHeight && a.addclassName("fixed-body-rows"),
        a.addclassName(b.style.table),
        "checkbox" === b.selectionMethod &&
          b.columns.splice(gj.grid.methods.getColumnPositionNotInRole(a), 0, {
            ...
            headerCssclassName: "gj-grid-select-all",
            stopPropagation: !0,
          }),
    ...
    renderHeader: function (a) {
      ...
      for (
        ...
        (g = $('<th data-field="' + (c[i].field || "") + '" />')),
          ...
          g.addclassName(d.cell),
          c[i].headerCssclassName && g.addclassName(c[i].headerCssclassName),
      ...
      a.find('thead tr th [data-role="sorticon"]').remove(),
        e &&
          ...
          position > -1 &&
            ...
            (b = $(
              '<div data-role="sorticon" className="gj-unselectable" />'
      ...
      gj.grid.methods.stopLoading(a),
        ...
        0 !== a.outerHeight() &&
          ...
          (c = $('<div data-role="loading-cover" />')
            .addclassName(h.style.loadingCover)
            .css({
              width: e,
              height: f,
              top: g,
          ...
          (d = $(
            '<div data-role="loading-text">' +
              ...
              "</div>"
          ).addclassName(h.style.loadingText)),
          d.insertAfter(a),
          c.insertAfter(a),
          d.css({
      ...
      for (
        h = a.data(),
          b && 0 !== b.length
            ? ((i = "update"),
              b
                .removeclassName(h.style.content.rowSelected)
      ...
      if (
        (b && 0 !== b.length
          ...
          : ((b = $("<td/>")),
            ...
            c.cssclassName && b.addclassName(c.cssclassName),
            b.append(g),
            (f = "create")),
    ...
    renderDisplayElement: function (a, b, c, d, e, f) {
      ...
      "checkbox" === c.type && gj.checkbox
        ...
        ? "create" === f &&
          (b.append(
            $("<span/>").addclassName(c.icon).css({
              cursor: "pointer",
            })
          ),
          "bootstrap" === a.data().uiLibrary &&
            b.children("span").addclassName("glyphicon"),
          (c.stopPropagation = !0))
        : c.tmpl
        ? ((g = c.tmpl),
    ...
    selectRow: function (a, b, c, d) {
      var e;
      return (
        c.addclassName(b.style.content.rowSelected),
    ...
    unselectRow: function (a, b, c, d) {
      ...
      if ("true" === c.attr("data-selected"))
        return (
          c.removeclassName(b.style.content.rowSelected),
          "checkbox" === b.selectionMethod &&
      ...
      return (
        a.data() &&
          ...
          !1 === c &&
            ...
            a.unwrap(),
          a.removeData(),
          !1 === b ? a.remove() : a.removeclassName().empty(),
          a.removeAttr("data-type")),
        a
      );
    },
  ...
  (gj.grid.plugins.fixedHeader = {
    ...
    private: {
      init: function (a) {
        ...
        a.addclassName("gj-grid-scrollable"),
      ...
      $.extend(!0, a, gj.grid.plugins.expandCollapseRows.public),
        void 0 !== c.detailTemplate &&
          ((b = {
            ...
            align: "center",
            stopPropagation: !0,
            cssclassName: "gj-cursor-pointer gj-unselectable",
    ...
    base: {
      ...
      inlineEditing: {
        ...
        managementColumnConfig: {
          ...
          cssclassName: "gj-grid-management-column",
        },
      },
    },
    bootstrap: {
    ...
    localization: function (a) {
      "bootstrap" === a.uiLibrary
        ? ((a.inlineEditing.editButton =
            '<button role="edit" className="btn btn-default btn-sm"><span className="glyphicon glyphicon-pencil" aria-hidden="true"></span> ' +
            gj.grid.messages[a.locale].Edit +
            "</button>"),
          (a.inlineEditing.deleteButton =
            '<button role="delete" className="btn btn-default btn-sm gj-margin-left-10"><span className="glyphicon glyphicon-remove" aria-hidden="true"></span> ' +
            gj.grid.messages[a.locale].Delete +
            "</button>"),
          (a.inlineEditing.updateButton =
            '<button role="update" className="btn btn-default btn-sm"><span className="glyphicon glyphicon-ok" aria-hidden="true"></span> ' +
            gj.grid.messages[a.locale].Update +
            "</button>"),
          (a.inlineEditing.cancelButton =
            '<button role="cancel" className="btn btn-default btn-sm gj-margin-left-10"><span className="glyphicon glyphicon-ban-circle" aria-hidden="true"></span> ' +
            gj.grid.messages[a.locale].Cancel +
            "</button>"))
        : ((a.inlineEditing.editButton =
            '<button role="edit" className="gj-button-md"><i className="gj-icon pencil" /> ' +
            gj.grid.messages[a.locale].Edit.toUpperCase() +
            "</button>"),
          (a.inlineEditing.deleteButton =
            '<button role="delete" className="gj-button-md"><i className="gj-icon delete" /> ' +
            gj.grid.messages[a.locale].Delete.toUpperCase() +
            "</button>"),
          (a.inlineEditing.updateButton =
            '<button role="update" className="gj-button-md"><i className="gj-icon check-circle" /> ' +
            gj.grid.messages[a.locale].Update.toUpperCase() +
            "</button>"),
          (a.inlineEditing.cancelButton =
            '<button role="cancel" className="gj-button-md"><i className="gj-icon cancel" /> ' +
              ...
              "dropdown" === c.type && gj.dropdown
                ...
                : ((g = $(
                    '<input type="text" value="' +
                      h +
                      '" className="gj-width-full"/>'
                  )),
                  "materialdesign" === j.uiLibrary &&
                    g
                      .addclassName("gj-textbox-md")
          ...
          !0 !== d &&
            ...
            "editOnly" !== c.mode &&
              ...
              0 === b.find("span.gj-dirty").length &&
                b.prepend($('<span className="gj-dirty" />'))),
    ...
    private: {
          ...
          for (
            d.params[d.paramNames.page] || (d.params[d.paramNames.page] = 1),
              ...
              f = $('<div data-role="display" />')
                .addclassName(d.style.pager.panel)
                .css({
                  float: "left",
                }),
              g = $('<div data-role="display" />')
      ...
      localizationBootstrap4: function (a) {
        ...
        void 0 === a.pager.leftControls &&
          (a.pager.leftControls = [
            $(
              '<button className="btn btn-default btn-sm gj-cursor-pointer">' +
                (a.icons.first || b.First) +
                "</button>"
            )
              .attr("title", b.FirstPageTooltip)
      ...
      localizationMaterialDesign: function (a) {
        ...
        void 0 === a.pager.leftControls && (a.pager.leftControls = []),
          void 0 === a.pager.rightControls &&
            (a.pager.rightControls = [
              $('<span className="">' + b.RowsPerPage + "</span>"),
              $(
              ...
              $(
                '<span className="gj-grid-mdl-pager-label">' + b.Of + "</span>"
              ),
              $('<span data-role="record-total" className="">0</span>'),
              $('<span className="gj-md-spacer-32">&nbsp;</span>'),
              $(
                '<button className="gj-button-md">' +
                  (a.icons.previous || b.Previous) +
                  "</button>"
              )
                .attr("title", b.PreviousPageTooltip)
                .attr("data-role", "page-previous")
                .addclassName(a.icons.first ? "gj-button-md-icon" : ""),
      ...
      assignPageHandler: function (a, b, c, d) {
        ...
        d
          ? b.addclassName(e.stateDisabled).prop("disabled", !0).off("click")
          : b
              .removeclassName(e.stateDisabled)
              .prop("disabled", !1)
              .off("click")
              .on("click", function () {
      ...
      assignButtonHandler: function (a, b, c, d, e) {
        ...
        d < 1 || d > e
          ...
          : (b.show().off("click").text(d),
            d === c
              ? b.addclassName(f.activeButton)
              : b.removeclassName(f.activeButton).on("click", function () {
                ...
                ? ((j =
                  ...
                  h && h.length
                    ...
                    : ((h = $('<div data-id="' + i.field + '"/>').html(j)),
                      h.addclassName(c.style.rowDetailItem),
                      (g && g.length) || (g = $('<div className="row"/>')),
                      g.append(h)))
                : h && h.length && h.remove();
          a.updateDetails(f);
        }
      ...
      init: function (a) {
        ...
        (b = a.data()),
          ...
          (void 0 !== b.toolbarTemplate ||
            ...
            c.addclassName(b.style.toolbar),
            0 === c.children().length &&
              b.toolbarTemplate &&
      ...
      init: function (a, b) {
        ...
        if (((c = a.find('thead tr[data-role="caption"] th')), c.length)) {
          for (e = 0; e < c.length - 1; e++)
            (d = $(c[e])),
              (f = $('<div className="gj-grid-column-resizer-wrapper" />')),
              (h = parseInt(d.css("padding-right"), 10) + 3),
              (g = $('<span className="gj-grid-column-resizer" />').css(
                "margin-right",
                "-" + h + "px"
              )),
              g.draggable({
                start: function () {
                  a.addclassName("gj-unselectable"),
                    a.addclassName("gj-grid-resize-cursor");
                },
                stop: function () {
                  a.removeclassName("gj-unselectable"),
                    a.removeclassName("gj-grid-resize-cursor"),
        ...
        return function (c, d) {
          $('table[data-role="draggable-clone"]').draggable("destroy").remove(),
            ...
            b.siblings('tr[data-role="row"]').each(function () {
              ...
              i.removeclassName("gj-grid-top-border"),
                i.removeclassName("gj-grid-bottom-border"),
                i.droppable("destroy");
            });
        };
      },
      createDroppableOverHandler: function (a) {
        return function (b) {
          ...
          c.data("position") < a.data("position")
            ? c.addclassName("gj-grid-top-border")
            : c.addclassName("gj-grid-bottom-border");
        };
      },
      droppableOut: function () {
        $(this).removeclassName("gj-grid-top-border"),
          $(this).removeclassName("gj-grid-bottom-border");
      },
    },
    public: {},
    configure: function (a, b, c) {
        ...
        return function (c, d) {
          $('table[data-role="draggable-clone"]').draggable("destroy").remove(),
            ...
            b.siblings("th").each(function () {
              ...
              c
                .removeclassName("gj-grid-left-border")
                .removeclassName("gj-grid-right-border"),
                c
                  .closest("table")
                  .find(
      ...
      createDroppableOverHandler: function (a, b) {
        return function (c) {
          ...
          gj.grid.methods.getColumnPosition(e.columns, b.data("field"))
            ? (d.addclassName("gj-grid-left-border"),
              a
                .find(
                  'tbody tr[data-role="row"] td:nth-child(' +
                    (d.index() + 1) +
                ...
                .addclassName("gj-grid-left-border"))
            : (d.addclassName("gj-grid-right-border"),
              a
                .find(
                  'tbody tr[data-role="row"] td:nth-child(' +
                    (d.index() + 1) +
                ...
                .addclassName("gj-grid-right-border"));
        };
      },
      droppableOut: function () {
        var a = $(this);
          ...
          a.on("rowDataBound", function (d, e, f, g) {
            if (b !== g[c.grouping.groupBy] || 1 === e[0].rowIndex) {
              var h = gj.grid.methods.countVisibleColumns(a) - 1,
                i = $('<tr role="group" />'),
                j = $(
                  '<td className="gj-text-align-center gj-unselectable gj-cursor-pointer" />'
                );
              j.append(
  ...
  (gj.tree.config = {
    base: {
      ...
      imageCssclassNameField: "imageCssclassName",
  ...
  (gj.tree.methods = {
    ...
    initialize: function () {
      var a = this.data(),
        b = $('<ul className="' + a.style.list + '"/>');
      this.empty().addclassName(a.style.wrapper).append(b),
        a.width && this.width(a.width),
        a.border && this.addclassName(a.style.border),
    ...
    appendNode: function (a, b, c, d, e) {
      ...
      if (
        ((g = $('<li data-id="' + l + '" data-role="node" />').addclassName(
          k.style.item
        )),
        ($wrapper = $('<div data-role="wrapper" />')),
        ($expander = $(
          '<span data-role="expander" data-mode="close"></span>'
        ).addclassName(k.style.expander)),
        ($display = $(
        ...
        k.imageCssclassNameField && c[k.imageCssclassNameField]
          ? ((i = $(
              '<span data-role="image"><span className="' +
                c[k.imageCssclassNameField] +
                '"></span></span>'
            )),
        ...
        if (
          ...
          (h = $("<ul />")
            .addclassName(k.style.list)
            .addclassName("gj-hidden")),
          g.append(h),
        ...
        k.style.leafIcon
          ? $expander.addclassName(k.style.leafIcon)
          : $expander.html("&nbsp;");
    ...
    select: function (a, b, c) {
      ...
      if (
        ...
        (b.addclassName(f.style.active).attr("data-selected", "true"), c)
      )
    ...
    unselect: function (a, b, c) {
      ...
      if (
        ...
        (b.removeclassName(a.data().style.active).removeAttr("data-selected"),
        c)
      )
        for (e = b.find("ul>li"), d = 0; d < e.length; d++)
        ...
        c && c.length
          ? ("li" === c[0].tagName.toLowerCase() &&
              (0 === c.children("ul").length &&
                ...
                c.append($("<ul />").addclassName(g.style.list))),
              (c = c.children("ul"))),
    ...
    private: {
          ...
          if (a.data("dragReady")) {
            ...
            a.data("dragReady", !1),
              (e = c
                ...
                .closest("div")
                .wrap('<li className="' + i.style.item + '" />')
                .closest("li")
                .wrap('<ul className="' + i.style.list + '" />')
                .closest("ul")),
              $("body").append(e),
              e
                .attr("data-role", "draggable-clone")
                .addclassName("gj-unselectable")
                .addclassName(i.style.dragEl),
              e
            ...
            if (b.droppable("isOver", c))
              return (
                ...
                f.style.dropAsChildIcon
                  ? a.addclassName(f.style.dropAsChildIcon)
                  : a.text("+"),
                (h = !0),
                !1
              );
            g.find('[data-role="indicator"]')
              .removeclassName(f.style.dropAsChildIcon)
              .empty();
          }),
            e.each(function () {
              var a,
              ...
              !h && b.droppable("isOver", c)
                ? ((a = b.position().top + b.outerHeight() / 2),
                  c.y < a
                    ? b
                        .addclassName(f.style.dropAbove)
                        .removeclassName(f.style.dropBelow)
                    : b
                        .addclassName(f.style.dropBelow)
                        .removeclassName(f.style.dropAbove))
                : b
                    .removeclassName(f.style.dropAbove)
                    .removeclassName(f.style.dropBelow);
            });
            ...
            d.each(function () {
              ...
              if (d.droppable("isOver", g))
                return (
                  ...
                  (c = i.children("ul")),
                  0 === c.length &&
                    ((c = $("<ul />").addclassName(f.style.list)), i.append(c)),
                  !1 !==
      ...
      refresh: function (a, b, c, d) {
        ...
        gj.tree.plugins.dragAndDrop.private.refreshNode(a, c),
          ...
          c
            ...
            .removeclassName(e.style.dropAbove)
            .removeclassName(e.style.dropBelow);
      },
      refreshNode: function (a, b) {
        ...
        f.length && f.children().length
          ...
          : d.empty(),
          c
            .removeclassName(g.style.dropAbove)
            .removeclassName(g.style.dropBelow),
        ...
        return function (c) {
          ...
          if (
            ...
            for (
              f = b.children("ul"),
                0 === f.length &&
                  ((f = $("<ul />").addclassName(g.style.list)), b.append(f)),
                d = 0;
              d < c.length;
              d++
            )
  ...
  (gj.checkbox.config = {
    base: {
      ...
      iconsLibrary: "materialicons",
      style: {
        wrapperCssclassName: "gj-checkbox-md",
        spanCssclassName: void 0,
      },
    },
    bootstrap: {
      style: {
        wrapperCssclassName: "gj-checkbox-bootstrap",
      },
      iconsLibrary: "glyphicons",
    },
    bootstrap4: {
      style: {
        wrapperCssclassName: "gj-checkbox-bootstrap gj-checkbox-bootstrap-4",
      },
      iconsLibrary: "materialicons",
    },
    materialicons: {
      style: {
        iconsCssclassName: "gj-checkbox-material-icons",
        spanCssclassName: "gj-icon",
      },
    },
    glyphicons: {
      style: {
        iconsCssclassName: "gj-checkbox-glyphicons",
        spanCssclassName: "",
      },
    },
    fontawesome: {
      style: {
        iconsCssclassName: "gj-checkbox-fontawesome",
        spanCssclassName: "fa",
      },
    },
  }),
  (gj.checkbox.methods = {
    ...
    initialize: function (a) {
      var b,
        c,
        d = a.data();
      d.style.wrapperCssclassName &&
        ((b = $(
          '<label className="' +
            d.style.wrapperCssclassName +
            " " +
            d.style.iconsCssclassName +
            '"></label>'
        )),
        a.attr("id") && b.attr("for", a.attr("id")),
        a.wrap(b),
        (c = $("<span />")),
        d.style.spanCssclassName && c.addclassName(d.style.spanCssclassName),
        a.parent().append(c));
    },
    state: function (a, b) {
      return b
  ...
  (gj.editor.methods = {
    ...
    initialize: function (a) {
      ...
      if (
        ...
        $(d).addclassName(h.style.wrapper),
        ...
        for (var i in h.buttons) {
          b = $("<div />").addclassName(h.style.buttonsGroup);
    ...
    updateToolbar: function (a, b) {
      ...
      $buttons = b.find("[role]").each(function () {
        ...
        "true" === document.queryCommandValue(b)
          ? a.addclassName(c.style.buttonActive)
          : a.removeclassName(c.style.buttonActive);
      });
    },
  ...
  (gj.dropdown.methods = {
    ...
    initialize: function (a) {
      var b = a.data(),
        ...
        ).addclassName(b.style.expander),
        f = $('<button role="presenter" type="button"></button>').addclassName(
          b.style.presenter
        ),
        g = $('<ul role="list" className="' + b.style.list + '"></ul>').attr(
          "guid",
          a.attr("data-guid")
        );
      0 === c.length
        ? ((c = $('<div role="wrapper" />').addclassName(b.style.wrapper)),
          a.wrap(c))
        : c.addclassName(b.style.wrapper),
      ...
      if ((a.data("records", b), a.empty(), f.empty(), b && b.length))
        if (
          ...
          a.prepend('<option value=""></option>'),
            ...
            d.placeholder &&
              (h[0].innerHTML =
                '<span className="placeholder">' + d.placeholder + "</span>");
    ...
    select: function (a, b) {
      ...
      return (
        d.children("li").removeclassName(c.style.active),
        g
          ? (e.addclassName(c.style.active),
            (a[0].value = b),
            (f[0].innerHTML = g[c.textField]))
          : (c.placeholder &&
              (f[0].innerHTML =
                '<span className="placeholder">' + c.placeholder + "</span>"),
            (a[0].value = "")),
  ...
  (gj.datepicker.methods = {
    ...
    initialize: function (a, b) {
      ...
      0 === e.length
        ? ((e = $('<div role="wrapper" />').addclassName(b.style.wrapper)),
          a.wrap(e))
        : e.addclassName(b.style.wrapper),
        (e = a.parent('div[role="wrapper"]')),
        ...
        "bootstrap" === b.uiLibrary || "bootstrap4" === b.uiLibrary
          ? "small" === b.size
            ? (e.addclassName("input-group-sm"),
              a.addclassName("form-control-sm"))
            : "large" === b.size &&
              (e.addclassName("input-group-lg"),
              a.addclassName("form-control-lg"))
          : "small" === b.size
          ? e.addclassName("small")
          : "large" === b.size && e.addclassName("large"),
        b.showRightIcon &&
          ((d =
            "bootstrap" === b.uiLibrary
              ? $(
    ...
    createCalendar: function (a, b) {
      ...
      return (
        ...
        h.append(d),
        b.footer &&
          ((e = $('<div role="footer" className="' + b.style.footer + '" />')),
          (f = $(
            '<button className="' +
              b.style.button +
              '">' +
        ...
        $("body").append(h),
        b.modal &&
          (h.wrapAll('<div role="modal" className="' + b.style.modal + '"/>'),
          gj.core.center(h)),
        h
      );
    },
    renderHeader: function (a, b, c, d) {
      ...
      c.header &&
        ...
        e.append(g),
        (f = $('<div role="date" className="selected" />').on(
          "click",
          function () {
      ...
      for (l > 1 && u.append($row), m = new Date(), l = 1; l <= j; l++)
        (r = new Date(h, g, l)),
          ...
          h === m.getFullYear() && g === m.getMonth() && l === m.getDate()
            ? p.addclassName("today")
            : p.addclassName("current-month"),
          (q = $("<div>" + l + "</div>")),
          gj.datepicker.methods.isSelectable(c, r)
            ? (p.addclassName("gj-cursor-pointer"),
    ...
    selectDay: function (a, b, c, d) {
      ...
      b.attr("selectedDay", g + "-" + f + "-" + e),
        b.find("tbody td").removeclassName("selected"),
        b
              ...
              i.is("[day]") ||
                ...
                i.is(":empty") &&
                  (i = b
                    ...
                    .find("td:eq(" + h + ")"))),
              i.is("[day]") &&
                (i.addclassName("focused"), j.removeclassName("focused")))
            : "40" == d.keyCode
            ? ((h = j.index()),
              (i = j
                .closest("tr")
  ...
  (gj.timepicker.methods = {
    ...
    createPicker: function (a) {
      var b,
        ...
        l = $('<div role="footer" className="' + c.style.footer + '" />');
      return (
        ...
        $("body").append(d),
        c.modal &&
          (d.wrapAll('<div role="modal" className="' + c.style.modal + '"/>'),
          gj.core.center(d)),
        d
      );
    },
    ...
    update: function (a, b, c) {
      ...
      (d = gj.timepicker.methods.getHour(b)),
        ...
        c.header &&
          ...
          "ampm" === c.mode &&
            (d >= 12
              ? (h.find('[role="pm"]').addclassName("selected"),
                h.find('[role="am"]').removeclassName("selected"))
              : (h.find('[role="am"]').addclassName("selected"),
                h.find('[role="pm"]').removeclassName("selected"))));
    },
    ...
    renderHours: function (a, b, c) {
      ...
      clearTimeout(a.timeout),
        ...
        (d = $('<div role="dial"></div>')),
        d.append(
          '<div role="arrow" style="transform: rotate(-90deg); display: none;"><div className="arrow-begin"></div><div className="arrow-end"></div></div>'
        ),
        d.append(
        ...
        e.append(d),
        b.find('[role="header"] [role="hour"]').addclassName("selected"),
        b.find('[role="header"] [role="minute"]').removeclassName("selected"),
        (c.dialMode = "hours"),
    ...
    renderMinutes: function (a, b, c) {
      ...
      clearTimeout(a.timeout),
        ...
        d.append($dial),
        b.find('[role="header"] [role="hour"]').removeclassName("selected"),
        b.find('[role="header"] [role="minute"]').addclassName("selected"),
        (c.dialMode = "minutes"),
        gj.timepicker.methods.update(a, b, c);
    },
    open: function (a) {
  ...
  (gj.datetimepicker.methods = {
    ...
    initialize: function (a) {
      ...
      (j.datepicker.uiLibrary = j.uiLibrary),
        ...
        a.on("open", function () {
          ...
          a.find('[role="calendarMode"]').addclassName("selected"),
            a.find('[role="clockMode"]').removeclassName("selected");
        }),
        (b = $("body").find(
          '[role="calendar"][guid="' + a.attr("data-guid") + '"]'
        )),
        ...
        (c = $('<div role="header" />')),
        (d = $('<div role="date" className="selected" />')),
        ...
        (h = $(
          '<i className="gj-icon selected" role="calendarMode">event</i>'
        )),
        ...
        g.append(e),
        (i = $('<i className="gj-icon" role="clockMode">clock</i>')),
    ...
    createShowDateHandler: function (a, b, c) {
      return function (d) {
        ...
        e.find('[role="calendarMode"]').addclassName("selected"),
          e.find('[role="date"]').addclassName("selected"),
          e.find('[role="clockMode"]').removeclassName("selected"),
          e.find('[role="hour"]').removeclassName("selected"),
          e.find('[role="minute"]').removeclassName("selected"),
    ...
    createShowHourHandler: function (a, b, c) {
      return function () {
        ...
        d.find('[role="calendarMode"]').removeclassName("selected"),
          d.find('[role="date"]').removeclassName("selected"),
          d.find('[role="clockMode"]').addclassName("selected"),
          d.find('[role="hour"]').addclassName("selected"),
          d.find('[role="minute"]').removeclassName("selected"),
    ...
    createShowMinuteHandler: function (a, b, c) {
      return function () {
        ...
        d.find('[role="calendarMode"]').removeclassName("selected"),
          d.find('[role="date"]').removeclassName("selected"),
          d.find('[role="clockMode"]').addclassName("selected"),
          d.find('[role="hour"]').removeclassName("selected"),
          d.find('[role="minute"]').addclassName("selected"),
          gj.timepicker.methods.initMouse(
            b.children('[role="body"]'),
            a,
            b,
  ...
  (gj.slider.methods = {
    ...
    initialize: function (a, b) {
      ...
      (a[0].style.display = "none"),
        ...
        gj.core.addclassNamees(c, b.style.wrapper),
        (d = a[0].querySelector('[role="track"]')),
        null == d &&
          ((d = document.createElement("div")),
          d.setAttribute("role", "track"),
          c.appendChild(d)),
        gj.core.addclassNamees(d, b.style.track),
        ...
        null == f &&
          ...
          c.appendChild(f)),
        gj.core.addclassNamees(f, b.style.progress),
