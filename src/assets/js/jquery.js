...
(function (a, b) {
  ...
  (p.Callbacks = function (a) {
    ...
    (p.support = (function () {
      ...
      n.setAttribute("classNameName", "t"),
        (n.innerHTML =
      ...
      (f = e.createElement("select")),
        ...
        (b = {
          ...
          getSetAttribute: n.classNameName !== "t",
  ...
  p.extend({
    ...
    acceptData: function (a) {
      ...
      return !b || (b !== !0 && a.getAttribute("classNameid") === b);
    },
  }),
    p.fn.extend({
      data: function (a, c) {
  ...
  p.fn.extend({
    ...
    addclassName: function (a) {
      ...
      if (p.isFunction(a))
        return this.each(function (b) {
          p(this).addclassName(a.call(this, b, this.classNameName));
        });
      if (a && typeof a == "string") {
        ...
        for (c = 0, d = this.length; c < d; c++) {
          e = this[c];
          if (e.nodeType === 1)
            if (!e.classNameName && b.length === 1) e.classNameName = a;
            else {
              f = " " + e.classNameName + " ";
              for (g = 0, h = b.length; g < h; g++)
                f.indexOf(" " + b[g] + " ") < 0 && (f += b[g] + " ");
              e.classNameName = p.trim(f);
            }
        }
      }
      return this;
    ...
    removeclassName: function (a) {
      ...
      if (p.isFunction(a))
        return this.each(function (b) {
          p(this).removeclassName(a.call(this, b, this.classNameName));
        });
      if ((a && typeof a == "string") || a === b) {
        c = (a || "").split(s);
        for (h = 0, i = this.length; h < i; h++) {
          e = this[h];
          if (e.nodeType === 1 && e.classNameName) {
            d = (" " + e.classNameName + " ").replace(O, " ");
            for (f = 0, g = c.length; f < g; f++)
              while (d.indexOf(" " + c[f] + " ") >= 0)
                d = d.replace(" " + c[f] + " ", " ");
            e.classNameName = a ? p.trim(d) : "";
          }
        }
      }
      return this;
    ...
    toggleclassName: function (a, b) {
      ...
      return p.isFunction(a)
        ? this.each(function (c) {
            p(this).toggleclassName(a.call(this, c, this.classNameName, b), b);
          })
        : this.each(function () {
            if (c === "string") {
              var e,
                ...
                i = a.split(s);
              while ((e = i[f++]))
                (h = d ? h : !g.hasclassName(e)),
                  g[h ? "addclassName" : "removeclassName"](e);
            } else if (c === "undefined" || c === "boolean") this.classNameName && p._data(this, "__classNameName__", this.classNameName), (this.classNameName = this.classNameName || a === !1 ? "" : p._data(this, "__classNameName__") || "");
          });
    },
    hasclassName: function (a) {
      ...
      for (; c < d; c++)
        if (
          this[c].nodeType === 1 &&
          (" " + this[c].classNameName + " ").replace(O, " ").indexOf(b) >= 0
        )
          return !0;
      return !1;
    },
        ...
        if (!i && !d)
          if ((e = P.exec(a)))
            if ((j = e[1])) {
              ...
              if ((j = e[3]) && _ && b.getElementsByclassNameName)
                return (
                  w.apply(c, x.call(b.getElementsByclassNameName(j), 0)), c
                );
            }
      ...
      var c,
        ...
        _ = X(function (a) {
          return (
            ...
            !a.getElementsByclassNameName ||
            !a.getElementsByclassNameName("e").length
              ? !1
              : ((a.lastChild.classNameName = "e"),
                a.getElementsByclassNameName("e").length === 2)
          );
        }),
        ba = X(function (a) {
          (a.id = o + 0),
        ...
        (e = bc.selectors =
          {
            ...
            find: {
              ...
              className:
                _ &&
                function (a, b, c) {
                  if (typeof b.getElementsByclassNameName !== n && !c)
                    return b.getElementsByclassNameName(a);
                },
            },
            relative: {
