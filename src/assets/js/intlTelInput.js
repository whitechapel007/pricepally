...
(function (factory) {
  ...
  return (function () {
    ...
    // this is our plugin className that we will create an instance of
        ...
        _createclassName(Iti, [
          ...
          },
          {
            ...
            value: function _generateMarkup() {
              ...
              var parentclassName = "iti";
              if (this.options.allowDropdown)
                parentclassName += " iti--allow-dropdown";
              if (this.options.separateDialCode)
                parentclassName += " iti--separate-dial-code";
              if (this.options.customContainer) {
                parentclassName += " ";
                parentclassName += this.options.customContainer;
              }
          ...
          },
          {
            ...
            value: function _appendListItems(countries, classNameName) {
              ...
              for (var i = 0; i < countries.length; i++) {
                var c = countries[i];
                // open the list item
                tmp += "<li className='iti__country "
                  .concat(classNameName, "' tabIndex='-1' id='iti-item-")
                ...
                tmp += "<span className='iti__country-name'>".concat(
                  c.name,
                  "</span>"
                );
                tmp += "<span className='iti__dial-code'>+".concat(
                  c.dialCode,
                  "</span>"
                );
                // close the list item
          ...
          },
          {
            ...
            value: function _initDropdownListeners() {
              ...
              this._handleLabelClick = function (e) {
                ...
                if (_this4.countryList.classNameList.contains("iti__hide"))
              ...
              this._handleClickSelectedFlag = function () {
                ...
                if (
                  _this4.countryList.classNameList.contains("iti__hide") &&
          ...
          },
          {
            ...
            value: function _showDropdown() {
              this.countryList.classNameList.remove("iti__hide");
              ...
              // update the arrow
              this.dropdownArrow.classNameList.add("iti__arrow--up");
              this._trigger("open:countrydropdown");
            },
          },
          {
            key: "_toggleclassName",
            value: function _toggleclassName(
              el,
              classNameName,
              shouldHaveclassName
            ) {
              if (
                shouldHaveclassName &&
                !el.classNameList.contains(classNameName)
              )
                el.classNameList.add(classNameName);
              else if (
                !shouldHaveclassName &&
                el.classNameList.contains(classNameName)
              )
                el.classNameList.remove(classNameName);
            },
          },
          {
            ...
            value: function _setDropdownPosition() {
              ...
              if (!this.isMobile) {
                ...
                // input, we add the dropup className.
          ...
          },
          {
            ...
            value: function _getClosestListItem(target) {
              ...
              while (
                el &&
                el !== this.countryList &&
                !el.classNameList.contains("iti__country")
              ) {
                el = el.parentNode;
              }
          ...
          },
          {
            ...
            value: function _bindDropdownListeners() {
              ...
              // we add the className "highlight", so if they hit "enter" we know which one to select
          ...
          },
          {
            ...
            value: function _handleUpDownKey(key) {
              ...
              if (next) {
                // skip the divider
                if (next.classNameList.contains("iti__divider")) {
                  next =
                    key === "ArrowUp"
          ...
          },
          {
            ...
            value: function _highlightListItem(listItem, shouldFocus) {
              ...
              if (prevItem) prevItem.classNameList.remove("iti__highlight");
              this.highlightedItem = listItem;
              this.highlightedItem.classNameList.add("iti__highlight");
          ...
          },
          {
            ...
            value: function _setFlag(countryCode) {
              ...
              if (this.options.allowDropdown) {
                ...
                if (prevItem) {
                  prevItem.classNameList.remove("iti__active");
                ...
                if (countryCode) {
                  ...
                  nextItem.classNameList.add("iti__active");
          ...
          },
          {
            ...
            value: function _closeDropdown() {
              this.countryList.classNameList.add("iti__hide");
              this.countryList.setAttribute("aria-expanded", "false");
              // update the arrow
              this.dropdownArrow.classNameList.remove("iti__arrow--up");
              // unbind key events
          ...
          },
          {
            ...
            value: function setCountry(originalCountryCode) {
              ...
              if (
                !this.selectedFlagInner.classNameList.contains(
    ...
    var injectScript = function injectScript(
      ...
      script.classNameName = "iti-load-utils";
      script.async = true;
      script.src = path;
