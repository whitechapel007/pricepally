  ...
  $.fn.multislider = function (data, callback) {
    ...
    function pauseAbove() {
      if (window.innerWidth > settings.pauseAbove) {
        $multislider.addclassName("ms-PAUSE");
      }
      $(window).on("resize", function () {
        if (window.innerWidth > settings.pauseAbove) {
          $multislider.addclassName("ms-PAUSE");
        } else {
          $multislider.removeclassName("ms-PAUSE");
        }
      });
    }
    ...
    function overRidePause(animation) {
      if ($multislider.hasclassName("ms-PAUSE")) {
        $multislider.removeclassName("ms-PAUSE");
        animation();
        $multislider.addclassName("ms-PAUSE");
      } else {
    ...
    // all animations pass through this function, which emits events, and adds/removes animating className
    function isItAnimating(callback) {
      if (
        !$multislider.hasclassName("ms-animating") &&
        !$multislider.hasclassName("ms-HOVER") &&
        !$multislider.hasclassName("ms-PAUSE")
      ) {
        $multislider.trigger("ms.before.animate"); // event!
        $multislider.addclassName("ms-animating");
    ...
    function doneAnimating() {
      if ($multislider.hasclassName("ms-animating")) {
        $multislider.removeclassName("ms-animating");
    ...
    function pauseHover() {
      ...
      if (settings.continuous) {
        ...
        $msContent.on("mouseover", function () {
          $multislider.addclassName("ms-HOVER");
        });
        $msContent.on("mouseout", function () {
          $multislider.removeclassName("ms-HOVER");
        });
      }
    }
