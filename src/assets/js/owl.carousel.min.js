...
!(function (a, b, c, d) {
        ...
        run: function () {
          ...
          for (g /= 2; g > 0; )
            b.push(this.normalize(b.length / 2, !0)),
              ...
              (g -= 1);
          (this._clones = b),
            a(h).addclassName("cloned").appendTo(this.$stage),
            a(i).addclassName("cloned").prependTo(this.$stage);
        },
      },
      {
        filter: ["width", "items", "settings"],
      ...
      (this.$stage = this.$element.find("." + this.settings.stageclassName)),
        this.$stage.length ||
          ...
          (this.$stage = a("<" + this.settings.stageElement + ">", {
            ...
            a("<div/>", { className: this.settings.stageOuterclassName })
          )),
  ...
  (function (a, b, c, d) {
        ...
        (this._handlers = {
          ...
          "loaded.owl.lazy": a.proxy(function (a) {
            a.namespace &&
              this._core.settings.autoHeight &&
              a.element
                .closest("." + this._core.settings.itemclassName)
    ...
    (e.Defaults = { autoHeight: !1, autoHeightclassName: "owl-height" }),
      (e.prototype.update = function () {
  ...
  (function (a, b, c, d) {
    ...
    (e.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
      ...
      (e.prototype.play = function (b) {
        var c,
          d = a(b.target),
          e = d.closest("." + this._core.settings.itemclassName),
        ...
        this._playing ||
          ...
          (this._playing = e.addclassName("owl-video-playing")));
      }),
      (e.prototype.isInFullScreen = function () {
        ...
        return b && a(b).parent().hasclassName("owl-video-frame");
      }),
      (e.prototype.destroy = function () {
        var a, b;
    ...
    (e.Defaults = {
      ...
      (e.prototype.initialize = function () {
        ...
        (this._controls.$relative = (
          c.navContainer
            ? a(c.navContainer)
            : a("<div>")
                .addclassName(c.navContainerclassName)
                .appendTo(this.$element)
        ).addclassName("disabled")),
          (this._controls.$previous = a("<" + c.navElement + ">")
            .addclassName(c.navclassName[0])
            .html(c.navText[0])
          ...
          (this._controls.$absolute = (
            c.dotsContainer
              ? a(c.dotsContainer)
              : a("<div>").addclassName(c.dotsclassName).appendTo(this.$element)
          ).addclassName("disabled")),
      ...
      (e.prototype.draw = function () {
        var b,
          ...
          f = c.loop || c.rewind;
        this._controls.$relative.toggleclassName("disabled", !c.nav || d),
          c.nav &&
          ...
          this._controls.$absolute.toggleclassName("disabled", !c.dots || d),
          c.dots &&
            ((b =
