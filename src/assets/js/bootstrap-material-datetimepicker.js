  ...
  Plugin.prototype = {
    ...
    initButtons: function () {
      ...
      if (this.params.clearButton === true) {
        ...
        this.$dtpElement.find(".dtp-btn-clear").removeclassName("hidden");
      }
      ...
      if (this.params.nowButton === true) {
        ...
        this.$dtpElement.find(".dtp-btn-now").removeclassName("hidden");
      }
    ...
    initDate: function (d) {
      ...
      if (this.params.monthPicker === false) {
        this.$dtpElement.find(".dtp-picker-calendar").removeclassName("hidden");
      }
      this.$dtpElement.find(".dtp-picker-datetime").addclassName("hidden");
      this.$dtpElement.find(".dtp-picker-year").addclassName("hidden");
    ...
    initHours: function () {
      ...
      this.$dtpElement.find(".dtp-picker-datetime").removeclassName("hidden");
      this.$dtpElement.find(".dtp-picker-calendar").addclassName("hidden");
      this.$dtpElement.find(".dtp-picker-year").addclassName("hidden");
      ...
      for (var i = 0; i < 12; i++) {
        ...
        var svgHourText = this.createSVGElement("text", {
          id: "th-" + i,
          className: "dtp-select-hour-text",
          "text-anchor": "middle",
          style: "cursor:pointer",
          "font-weight": "bold",
          "font-size": "20",
        ...
        if (!this.toggleTime(i, true)) {
          svgHourCircle.classNameName += " disabled";
          svgHourText.classNameName += " disabled";
      ...
      if (!this.params.shortTime) {
        ...
        this.$dtpElement.find("a.dtp-meridien-am").addclassName("hidden");
        this.$dtpElement.find("a.dtp-meridien-pm").addclassName("hidden");
      }
    ...
    initMinutes: function () {
      ...
      for (var i = 0; i < 60; i++) {
        ...
        if (!this.toggleTime(i, false)) {
          svgMinuteCircle.classNameName += " disabled";
        } else {
      ...
      for (var i = 0; i < 60; i++) {
        if (i % 5 === 0) {
          ...
          var svgMinuteText = this.createSVGElement("text", {
            id: "tm-" + i,
            className: "dtp-select-minute-text",
            "text-anchor": "middle",
            style: "cursor:pointer",
            "font-weight": "bold",
            "font-size": "20",
          ...
          if (!this.toggleTime(i, false)) {
            svgMinuteText.classNameName += " disabled";
    ...
    _fireCalendar: function () {
      ...
      if (this.params.date) {
        this.$dtpElement.find(".dtp-date").removeclassName("hidden");
        this.initDate();
      } else {
        if (this.params.time) {
          this.$dtpElement.find(".dtp-time").removeclassName("hidden");
          this.initHours();
        }
      }
    },
    ...
    _onActualYearClick: function () {
      if (this.params.year) {
        if (this.$dtpElement.find(".dtp-picker-year.hidden").length > 0) {
          this.$dtpElement.find(".dtp-picker-datetime").addclassName("hidden");
          this.$dtpElement.find(".dtp-picker-calendar").addclassName("hidden");
          this.$dtpElement.find(".dtp-picker-year").removeclassName("hidden");
    ...
    enableYearPicker: function () {
      ...
      this.$dtpElement.find(".dtp-actual-year").reomveclassName("disabled");
    },
    disableYearPicker: function () {
      this.params.year = false;
      this.$dtpElement.find(".dtp-actual-year").addclassName("disabled");
      this._closeYearPicker();
    },
    _onSelectDate: function (e) {
      this.$dtpElement.find("a.dtp-select-day").removeclassName("selected");
    ...
    _onSelectAM: function (e) {
      $(".dtp-actual-meridien").find("a").removeclassName("selected");
      $(e.currentTarget).addclassName("selected");
    ...
    show: function () {
      this.$dtpElement.removeclassName("hidden");
    ...
    hide: function () {
      ...
      this.$dtpElement.addclassName("hidden");
