...
!(function (n) {
  n.fn.multislider = function (e, t) {
    ...
    function w(n) {
      p.hasclassName("ms-PAUSE")
        ? (p.removeclassName("ms-PAUSE"), n(), p.addclassName("ms-PAUSE"))
        : n(),
        E();
    }
    function S() {
    ...
    function U(n) {
      p.hasclassName("ms-animating") ||
        p.hasclassName("ms-HOVER") ||
        p.hasclassName("ms-PAUSE") ||
        (p.trigger("ms.before.animate"), p.addclassName("ms-animating"), n());
    }
    function y() {
      p.hasclassName("ms-animating") &&
        (p.removeclassName("ms-animating"), p.trigger("ms.after.animate"));
    }
    function b() {
      ...
      ("object" != typeof e && void 0 !== e) ||
        ...
        m.hoverPause &&
          (m.continuous
            ...
            : (v.on("mouseover", function () {
                p.addclassName("ms-HOVER");
              }),
              v.on("mouseout", function () {
                p.removeclassName("ms-HOVER");
              }))),
        !0 !== m.continuous &&
          0 !== m.interval &&
          !1 !== m.interval &&
        ...
        null !== m.pauseAbove &&
          ...
          (window.innerWidth > m.pauseAbove && p.addclassName("ms-PAUSE"),
          n(window).on("resize", function () {
            window.innerWidth > m.pauseAbove
              ? p.addclassName("ms-PAUSE")
              : p.removeclassName("ms-PAUSE");
          })),
        null !== m.pauseBelow &&
          "number" == typeof m.pauseBelow &&
          (window.innerWidth < m.pauseBelow && p.addclassName("ms-PAUSE"),
          n(window).on("resize", function () {
